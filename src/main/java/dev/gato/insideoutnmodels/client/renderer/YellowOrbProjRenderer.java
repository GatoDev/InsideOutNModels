...
public class YellowOrbProjRenderer extends EntityRenderer<YellowOrbProjEntity> {
	private static ResourceLocation texture;
	private final Modelball_emotion_20240715T010112_Converted model;

	public YellowOrbProjRenderer(EntityRendererProvider.Context context, String textureName) {
		super(context);
	...
	@Override
	public void render(YellowOrbProjEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(YellowOrbProjEntity entity) {
		return texture;
	}
}
