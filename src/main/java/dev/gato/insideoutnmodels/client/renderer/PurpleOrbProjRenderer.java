...
public class PurpleOrbProjRenderer extends EntityRenderer<PurpleOrbProjEntity> {
	private static ResourceLocation texture;
	private final Modelball_emotion_20240715T010112_Converted model;

	public PurpleOrbProjRenderer(EntityRendererProvider.Context context, String textureName) {
		super(context);
	...
	@Override
	public void render(PurpleOrbProjEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(PurpleOrbProjEntity entity) {
		return texture;
	}
}
