...
public class OrangeOrbProjRenderer extends EntityRenderer<OrangeOrbProjEntity> {
	private static ResourceLocation texture;
	private final Modelball_emotion_20240715T010112_Converted model;

	public OrangeOrbProjRenderer(EntityRendererProvider.Context context, String textureName) {
		super(context);
	...
	@Override
	public void render(OrangeOrbProjEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(OrangeOrbProjEntity entity) {
		return texture;
	}
}
