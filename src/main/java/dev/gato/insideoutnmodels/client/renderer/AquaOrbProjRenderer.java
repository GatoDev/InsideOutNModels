...
public class AquaOrbProjRenderer extends EntityRenderer<AquaOrbProjEntity> {
	private static ResourceLocation texture;
	private final Modelball_emotion_20240715T010112_Converted model;

	public AquaOrbProjRenderer(EntityRendererProvider.Context context, String textureName) {
		super(context);
	...
	@Override
	public void render(AquaOrbProjEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(AquaOrbProjEntity entity) {
		return texture;
	}
}
