...
public class TNTProjectileItem extends Item {
	public TNTProjectileItem() {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				TNTProjectileEntity entityarrow = TNTProjectileEntity.shoot(world, entity, world.getRandom(), 1f, 5, 5);
