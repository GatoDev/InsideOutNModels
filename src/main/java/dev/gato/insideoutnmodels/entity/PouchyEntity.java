...
public class PouchyEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PouchyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PouchyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PouchyEntity.class, EntityDataSerializers.STRING);
	...
	public PouchyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InsideoutnmodelsModEntities.POUCHY.get(), world);
	}

	public PouchyEntity(EntityType<PouchyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "pouchy");
	}
	...
	public EntityDimensions getDimensions(Pose p_33597_) {
		return super.getDimensions(p_33597_).scale(1f, 0.2f);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PouchyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
	...
	private <E extends IAnimatable> PlayState talkPredicate(AnimationEvent<E> event) {
		...
		event.getController().clearAnimationCache();
		event.getController().isJustStarting = true;
		return PlayState.STOP;
	}
