...
public class EnnuiEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(EnnuiEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(EnnuiEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(EnnuiEntity.class, EntityDataSerializers.STRING);
	...
	public EnnuiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InsideoutnmodelsModEntities.ENNUI.get(), world);
	}

	public EnnuiEntity(EntityType<EnnuiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "ennui");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(EnnuiEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
