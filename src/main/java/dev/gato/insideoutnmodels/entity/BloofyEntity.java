...
public class BloofyEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BloofyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BloofyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BloofyEntity.class, EntityDataSerializers.STRING);
	...
	public BloofyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InsideoutnmodelsModEntities.BLOOFY.get(), world);
	}

	public BloofyEntity(EntityType<BloofyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "bloofy");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BloofyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
