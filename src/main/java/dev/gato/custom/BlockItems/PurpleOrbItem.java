...
public class PurpleOrbItem extends BlockItem {
    public PurpleOrbItem(Block p_40565_, Properties p_40566_) {
        ...
        if (!level.isClientSide()) {
            Projectile _entityToSpawn = new Object() {
                public Projectile getArrow(Level level, float damage, int knockback) {
                    AbstractArrow entityToSpawn = new PurpleOrbProjEntity(InsideoutnmodelsModEntities.PURPLE_ORB_PROJ.get(), level);
